...
/* Компонент создает блок Новостей*/
    ...
    <section className='above-search'>
      ...
      <section className='news'>
        ...
        <ul className='news__list'>
          <NewsItem text='Новостная строка 1' link='#0' src='#0'/>
          <NewsItem text='Новостная строка 2' link='#0' src='#0'/>
          <NewsItem text='Новостная строка 3' link='#0' src='#0'/>
          <NewsItem text='Новостная строка 4' link='#0' src='#0'/>
          <NewsItem text='Новостная строка 5' link='#0' src='#0'/>
        </ul>
      </section>
